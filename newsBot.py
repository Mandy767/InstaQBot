...
def daily_technews():
    def run_daily_code():
                ...
                try:
                    ...
                    def send_technews(username):
                        ...
                        try:
                                ...
                                try:
                                    ...
                                    news_container=browser2.find_element(By.CSS_SELECTOR, "div[class='story_list row margin_b20']")
                                    
                                    ul_element = news_container.find_element(By.TAG_NAME, "ul")
                                    ...
                                    for li in li_elements:
                                        try:
                                            ...
                                            reply_text.append(href)




                                        except NoSuchElementException:
                                            print("Unable to find 'a' element within 'li' element.")

                                    

                                   

                                    for news in reply_text:
                                    ...
                                    print("Unable to find 'ul' element.")
                    ...
                    browser2.get("https://www.gadgets360.com/internet/news")
                    ...
                    valid_users=['Shewale Chinmay','Mandar D']  #usernames whom to send quote
